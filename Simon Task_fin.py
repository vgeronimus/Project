...
text_stimulus = visual.TextStim(win0, text='', bold=True, pos=(0.0, 0.0), color=(1.0, 1.0, 1.0), height=60, wrapWidth=1100, units='pix')
feedback_stim = visual.TextStim(win0, text='', bold=False, pos=(0.0, 0.0), color=(1.0, 1.0, 1.0), height=50, wrapWidth=1100, units='pix')
...
# Show Start Screen
welcome_text = visual.TextStim(win0, text=f'In this task, you will be shown butterflies appearing on either the left or the right side of the screen. Press the left arrow key (<-) if the butterfly is purple and press the right arrow key (->) if the butterfly is yellow. If you do not respond within two seconds, the trial will time out. \n\nPress any key to start the Practice Trials!', bold=True, pos=(0.0, 0.0), color=(1.0, 1.0, 1.0), height=60, wrapWidth=1100, units='pix')
welcome_text.draw()
win0.flip()
...
for i in range(len(color_practice)): 
    ...
    if position_practice[i] == "left":      
        current_butterfly.pos = (-0.4, 0)   # show colored butterfly on the side given in stimuli.csv, position = distance from middle line 
        white_butterfly.pos = (0.4, 0)      # show neutral butterfly on the other side
    else:  # position == "right"
        current_butterfly.pos = (0.4, 0) 
        white_butterfly.pos = (-0.4, 0)
...
# Show Start Screen
welcome_text.text = f"In this task, you will be shown butterflies appearing on either the left or the right side of the screen. Press the left arrow key (<-) if the butterfly is purple and press the right arrow key (->) if the butterfly is yellow. If you do not respond within two seconds, the trial will time out. \n\nPress any key to start the {total_trials}-trial test!"
welcome_text.draw()
win0.flip()
...
for i in range(len(color)): 
    ...
    if position[i] == "left":
        current_butterfly.pos = (-0.4, 0)   # show colored butterfly on the side given in stimuli.csv
        white_butterfly.pos = (0.4, 0)      # show neutral butterfly on the other side
    else:  # position == "right"
        current_butterfly.pos = (0.4, 0)
        white_butterfly.pos = (-0.4, 0)
